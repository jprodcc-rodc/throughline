# Rodspan Marketing Site Design Spec
...
**Authority**: Companion to `web-product-design.md`. Visual system shared. Source of decisions: `2026-05-01-rodspan-brainstorm.md`.
...
| Discord | `Rodspan` 服务器(Phase 3 community) |
